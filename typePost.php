...
<body>
	<div class="type">
		<div class="border">
			<form action="addPostToDB.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data">
				<input type="text" name="title" id="title" placeholder="Untitled Document">
				<ul>
					...
					<li><button id="post" class="button" name="submit" style="width:100px; height:30px;">POST</button></li>
				</ul>
				<br><br>
				<input type="file" name="pict" class="left">
				<input type="text" name="category" placeholder="category">
				<div style="width: 100%;">
					<textarea rows="50" cols="150" placeholder="What are you thinking?" id="content" name="content"></textarea>
				</div>
			</form>
		</div>
	</div>
